...
\end{exmp}
\begin{enumerate}
    \item \fbox{Select project B1 for infinite planning horizon.}
    \item \fbox{Select project B1 for infinite planning horizon.}
\end{enumerate}
...
\end{exmp}
\begin{enumerate}
    \item \fbox{Select model B}
    \item \fbox{A salvage value of \$1874.19 would make both models indifferent.}
\end{enumerate}
...
\end{exmp}
\begin{center}
    \fbox{\$284,983.83 should be added to the foundation.}
\end{center}
...
\end{exmp}
\begin{enumerate}
    \item \fbox{$X = \$3,174.73$}
    \item \fbox{You should accept project B.}
\end{enumerate}
