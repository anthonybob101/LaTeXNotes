...
%IRR can't be solved by hand unless the problem is less than 4 years - you'll need to use excel.
%5-10-23 try to finish lecture 12 and 13 today, want to do review session on monday 
...
\begin{enumerate}
    ...
    \item Accumulated Cash Flow Sign Test
        ...
        \end{enumerate}
\end{enumerate}
%This goes back to the NPW analysis - where as you change the interest rate, there is no IRR that will give you a NPW that equals 0.
...
\begin{equation*}
    ...
    \end{aligned}
\end{equation*}
%//TODO - Complete Direct Solution Method for project A!
